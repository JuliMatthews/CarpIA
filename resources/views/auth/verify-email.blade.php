<x-guest-layout>
    ...
    <div class="mt-4 flex items-center justify-between">
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <button type="submit" class="underline text-sm text-[#888888] hover:text-[#f0f0f0] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7c3aed]">
                {{ __('Cerrar sesión') }}
            </button>
        </form>
    </div>
