<x-app-layout>
    <div class="flex items-center justify-center min-h-screen bg-[#0d0d0d]">
        <div class="w-full max-w-md bg-[#161616] border border-[#2a2a2a] rounded-2xl p-8 flex flex-col items-center text-center">
